        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-6 font-light">Aspiring Full-Stack Developer & IT Undergraduate</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {highlights.map((highlight, index) => (
                <div key={index} className="text-center p-6 hover:bg-white/10 transition-all duration-500 group rounded-lg border border-transparent hover:border-secondary/30 hover:shadow-xl hover:shadow-amber/10 transform hover:scale-105 hover:-translate-y-2 relative overflow-hidden">
                  <div className="flex justify-center mb-3 group-hover:scale-125 transition-transform duration-500">{highlight.icon}</div>
                  <h3 className="text-white font-semibold mb-2 group-hover:text-secondary transition-colors duration-300">{highlight.title}</h3>
