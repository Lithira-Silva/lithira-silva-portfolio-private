    ...
    <section id="contact" className="py-20 bg-black relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto hover:text-gray-200 transition-colors duration-300">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-500 hover:bg-white/8 hover:shadow-xl hover:shadow-white/10">
            <h3 className="text-2xl font-bold text-white mb-6 group-hover:text-gray-200 transition-colors duration-300">Send a Message</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-gray-800/60 border border-gray-600/40 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-secondary focus:ring-2 focus:ring-secondary/30 transition-all duration-300 hover:bg-gray-800/80 hover:border-secondary/40 backdrop-blur-sm"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 bg-gray-800/60 border border-gray-600/40 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-secondary focus:ring-2 focus:ring-secondary/30 transition-all duration-300 resize-none hover:bg-gray-800/80 hover:border-secondary/40 backdrop-blur-sm"
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-gradient-to-r from-secondary to-secondary-hover hover:from-secondary-hover hover:to-secondary-active text-white rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="space-y-8">
            <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-500 hover:bg-white/8 hover:shadow-xl hover:shadow-white/10">
              <h3 className="text-2xl font-bold text-white mb-6 group-hover:text-gray-200 transition-colors duration-300">Get in Touch</h3>
              ...
              <div className="space-y-4">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="text-gray-400 text-sm group-hover/item:text-gray-300 transition-colors duration-300">{info.label}</p>
                      <p className="text-white font-medium group-hover/item:text-gray-200 transition-colors">
                        {info.value}
                      </p>
                    </div>
                  </a>
            ...
            <div className="group bg-gray-800/60 backdrop-blur-sm rounded-2xl p-8 border border-gray-600/30 hover:border-secondary/40 transition-all duration-500 hover:bg-gray-800/80 hover:shadow-xl hover:shadow-amber/10">
              <h3 className="text-xl font-bold text-white mb-6 group-hover:text-secondary transition-colors duration-300">Follow Me</h3>
