                ...
                <div className="flex gap-4">
                  {project.githubUrl && (
                    <a 
                      ...
                      className="flex items-center gap-2 px-4 py-2 border border-secondary/45 text-secondary rounded-lg hover:bg-secondary hover:text-black transition-all duration-300 font-sans group/link"
                    >
                  ...
                  {project.demoUrl && (
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-secondary to-secondary-hover text-black rounded-lg hover:from-secondary-hover hover:to-secondary-active transition-all duration-300 font-sans shadow-lg shadow-secondary/30 group/link"
                    >
